...
while cap.isOpened():
    ...
    if results.multi_face_landmarks:
        ...
        cv2.putText(image, f'Pitch: {pitch}', (20, 30),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (200, 0, 200), 2)
        cv2.putText(image, f'Yaw: {yaw}', (20, 60),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (200, 0, 200), 2)
        cv2.putText(image, f'Roll: {roll}', (20, 90),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.7, (200, 0, 200), 2)
        cv2.putText(image, f'Head Direction: {direction}', (20, 130),
